"""
this script's purpose is to receive the results of the spamCheck operation and export it to a MySQL database, a
CSV file. and email it to a specified email. and also turn them into a JSON and send it back through the request API.
"""
